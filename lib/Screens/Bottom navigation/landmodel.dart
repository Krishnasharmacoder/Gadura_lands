...
//   LandModel({required this.message, required this.data});
...
//   DocumentMedia({required this.landPhoto, required this.landVideo});
...
class Datum {
  ...
  GpsTracking gpsTracking;
  DisputeDetails disputeDetails;
  DocumentMedia documentMedia; // ✅ CORRECT SPELLING
  ...
  Datum({
    ...
    required this.gpsTracking,
    required this.disputeDetails,
    required this.documentMedia, // ✅ CORRECT SPELLING
  });

  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    id: json["id"], // ✅ ADDED THIS
    landId: json["land_id"],
    landLocation: LandLocation.fromJson(json["land_location"]),
    farmerDetails: FarmerDetails.fromJson(json["farmer_details"]),
    landDetails: LandDetails.fromJson(json["land_details"]),
    gpsTracking: GpsTracking.fromJson(json["gps_tracking"]),
    disputeDetails: DisputeDetails.fromJson(json["dispute_details"]),
    documentMedia: DocumentMedia.fromJson(
      json["document_media"],
    ), // ✅ CORRECT SPELLING
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "gps_tracking": gpsTracking.toJson(),
    "dispute_details": disputeDetails.toJson(),
    "document_media": documentMedia.toJson(), // ✅ CORRECT SPELLING
  };
}
...
class DocumentMedia {
  List<String>? landPhotos; // ✅ CHANGED FROM landPhoto TO landPhotos
  List<String>? landVideos; // ✅ CHANGED FROM landVideo TO landVideos

  DocumentMedia({this.landPhotos, this.landVideos});

  factory DocumentMedia.fromJson(Map<String, dynamic> json) => DocumentMedia(
    landPhotos: json["land_photo"] != null
        ? List<String>.from(json["land_photo"].map((x) => x))
        : [], // ✅ NULL SAFETY
    landVideos: json["land_video"] != null
        ? List<String>.from(json["land_video"].map((x) => x))
        : [], // ✅ NULL SAFETY
  );

  Map<String, dynamic> toJson() => {
    "land_photo": landPhotos != null
        ? List<dynamic>.from(landPhotos!.map((x) => x))
        : [],
    "land_video": landVideos != null
        ? List<dynamic>.from(landVideos!.map((x) => x))
        : [],
  };
}

// ✅ ADDED THIS COMPATIBILITY CLASS FOR EditLandScreen
class DocumentsMedia {
  List<String>? landPhotos;
  List<String>? landVideos;

  DocumentsMedia({this.landPhotos, this.landVideos});

  factory DocumentsMedia.fromDocumentMedia(DocumentMedia docMedia) =>
      DocumentsMedia(
        landPhotos: docMedia.landPhotos,
        landVideos: docMedia.landVideos,
      );
}
...
class GpsTracking {
  ...
  GpsTracking({this.roadPath, this.latitude, this.longitude, this.landBorder});
